...
public:
	...
	void AddSimCharacter(std::shared_ptr<SimCharacter> sim_character);
	...
	inline const std::vector<std::shared_ptr<SimCharacter>>& getSimCharacters() { return m_sim_character_vec; };
...
private:
	...
	std::vector < std::shared_ptr<SimCharacter>> m_sim_character_vec;
