...
public:
	Transform();
	Transform(const glm::vec3& pos, const glm::quat& q, const glm::vec3& scale);
	...
	glm::quat				getRotationWorld();
	glm::mat4				getRotationMatWorld();
	inline const glm::mat4& getScaleMat() const { return m_scaleMat; }
	const glm::mat4&		getRotationMat() const { return m_rotationMat; }
	const glm::mat4&		getTranslationMat() const { return m_translationMat; }
